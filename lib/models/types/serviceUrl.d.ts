...
export declare type ServiceUrl<T> = `services/${Service}/${T extends ElectricityRequest ? 'verify' | 'request' : T extends DataBundleRequest ? 'bundles' | 'request' : T extends CableRequest ? 'list' | 'addons' | 'request' : 'request'}`;
